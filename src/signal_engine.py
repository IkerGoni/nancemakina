...
class SignalEngineV1:
    ...
    def _get_pair_specific_config(self, config_symbol: str) -> Dict[str, Any]:
        ...
        merged_config["tp_options"] = {
            "primary_type": pair_tp_options.get("primary_type", global_tp_options.get("primary_type", "r_multiple")),
            "r_multiple_settings": {
                "r_value": pair_tp_options.get("r_multiple_settings", {}).get("r_value", 
                          global_tp_options.get("r_multiple_settings", {}).get("r_value", 
    ...
    def _calculate_take_profit(self, entry_price: float, stop_loss_price: float, direction: TradeDirection, tp_config: Dict[str, Any]) -> Optional[float]:
        ...
        # Get primary method
        primary_type = tp_config.get("primary_type", "r_multiple")
        ...
        if primary_type == "r_multiple":
            # Use R multiple approach
            r_value = tp_config.get("r_multiple_settings", {}).get("r_value", 3.0)
